		                		      ...
		                		      <div class="form-group" >
			                            ...
			                            <input type="text" class="form-control" id="MaDeThiChinhSua" name="" value="14AV11" readonly>
			                       	   ...
			                       	   <div class="form-group col-md-offset-1" >
				                            <label class="control-label" >Nhập tên phòng thi:</label>
				                             <input name="Name_NhapTenPhongThiChinhSua" ng-model="Model_NhapTenPhongThiChinhSua" class="form-control " id="NhapTenPhongThiChinhSua" required>
                              				<span class="ChuaNhapValue"  ng-show="FormCapNgayThiChinhSua.Name_NhapTenPhongThiChinhSua.$touched && FormCapNgayThiChinhSua.Name_NhapTenPhongThiChinhSua.$invalid">Chưa nhập tên phòng</span>
				                       </div>
			                        </div>
		                		    ...
		                		    <div class="form-inline" >
		                		      <div class="form-group" >
			                            ...
			                            <input type="text" class="form-control" id="MaDeThi" name="" value="14AV11" readonly>
			                       	  ...
			                       	  <div class="form-group col-md-offset-1" >
				                            <label class="control-label" >Nhập tên phòng thi:</label>
				                             <input name="Name_NhapTenPhongThi" ng-model="Model_NhapTenPhongThi" class="form-control " id="NhapTenPhongThi" required>
                              				<span class="ChuaNhapValue"  ng-show="FormCapNgayThi.Name_NhapTenPhongThi.$touched && FormCapNgayThi.Name_NhapTenPhongThi.$invalid">Chưa nhập ten phong</span>
				                       </div>
			                        </div>
			                        <div class="form-inline" style="padding-top: 30px;">
				                       ...
				                       <div class="form-group input-append1" id="datepicker" style="padding-right: 20px;">
			                              	  <label class="control-label" >Nhập ngày thi:</label>
												  ...
												  <input data-format="yyyy-MM-dd" id="NhapNgayThi" type="text" class="form-control" size="11px" required>
												  <span class="add-on">
										...
										<div class="form-group input-append" id="timepicker"  style="padding-right: 20px;">
					                            <label class="control-label">Nhập thời gian bắt đầu:</label>
											    <input  data-format="hh:mm:ss" id="NhapGioBatDauThi" type="text" class="form-control" size="8px" required>
											    <span class="add-on">
										...
										<div class="form-group input-append" id="timepicker1">
					                           <label class="control-label">Nhập thời gian kết thúc:</label>
												 ...
												 <input  data-format="hh:mm:ss" id="NhapGioKetThucThi"  type="text" class="form-control" size="8px" required>
												  <span class="add-on">
