                  ...
                  <div class="tab-pane fade in active" id="thongbao" >
                     <div id="caibangsinhvien">
                       <table style="background: #E6E6FA" class="table table-hover table-striped">
                         ...
                         <tbody>
                           <tr>
                             <td class="cot1">đổi lịch thi lại vào thứ 7</td>
                             <td class="cot2">Võ Thanh Tùng</td>
                             <td class="cot3">25/09/2016 7:40:35</td>
                             <td class="cot4"> <a href="#" id="ChiTiet" onclick="XemChiTiet()" >chi tiết</a></td>
                           </tr>
                            <tr>
                             <td class="cot1">đổi lịch thi lại vào thứ 7</td>
                             <td class="cot2">Võ Thanh Tùng</td>
                  ...
                  <div class=" tab-pane fade" id="xemlichthi" > 
                          ...
                          <div id="caibangsinhvien_XemLichThi">
                            <table style="background: #E6E6FA" class="table table-hover table-striped ">
                              <thead>
                                <tr>
                                  <th class="cot1">BỘ MÔN</th>
                                  <th class="cot2">SỐ TÍN CHỈ</th>
                              ...
                              <tbody>
                                 <tr>
                                  <td class="cot1">Anh văn 1</td>
                                  <td class="cot2">3</td>
                                  <td class="cot3">14/12/2016</td>
                                  <td class="cot4">7:00</td>
                                </tr>
                                <tr>
                                  <td class="cot1">Anh văn 1</td>
                                  <td class="cot2">3</td>
                  ...
                  <div class=" tab-pane fade  " id="bailamthi" >
                        <form  class="form-inline" style="background:#E6E6FA;  padding: 10px 40px; text-align: center;">
                          <div class="form-group">
                              ...
                              <select class="form-control" style="padding-right: 90px" id="selectMonHoc">
                              ...
                              <table style="background: #E6E6FA" class="table table-hover table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <th class="cot5">Điểm giữa kỳ</th>
                                    <th class="cot6">Điểm cuối kỳ</th>
                                    <th class="cot7">Điểm trung bình</th>
                                    <th class="cot8">Kết quả</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <tr>
                                    <td class="cot1">1</td>
                                    <td class="cot2">AV1411</td>
                                    <td class="cot3">Anh văn 1</td>
                                    <td class="cot4">3</td>
                                    <td class="cot5">8</td>
                                    <td class="cot6">8</td>
                                    <td class="cot7">8</td>
                                    <td class="cot8"><input type="checkbox" name=""></td>
                                  </tr>
                                    <tr>
                                    <td class="cot1">1</td>
                                    <td class="cot2">AV1411</td>
