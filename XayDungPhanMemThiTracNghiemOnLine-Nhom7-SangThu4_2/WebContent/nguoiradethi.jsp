	                	...
	                	<div class="tab-pane fade " id="ChinhSuaDeThi">
							 <form name="FormChinhSuaDeThi_ALL">
	                                <div class="form-inline" id="formChonDanhSachLopThi" style="background: #E6E6FA; padding: 25px 25px; color:#0000CC">
	                                 ...
	                                 <br>
									 <div style="background: #E6E6FA; padding: 25px 25px 10px 25px; color:#0000CC">
                                 	    <div class="form-group">
			                              <label class="control-label" >Nhập tên đề thi chính:</label>
			                            
			                                <input type="text" class="form-control" name="Name_TenDeChinhChinhSua" id="TenDeChinhChinhSua" ng-model="Model_TenDeChinhChinhSua"  required>
											<span class="ChuaNhapValue" ng-show="FormChinhSuaDeThi_ALL.Name_TenDeChinhChinhSua.$touched && FormChinhSuaDeThi_ALL.Name_TenDeChinhChinhSua.$invalid">Chưa nhập tên đề thi</span>
			                            </div>
                                  </div >
								     <div  class="form-inline"  style="background: #E6E6FA; padding: 10px 25px 25px 25px; color:#0000CC">
		                			   <div class="form-group " style="padding-right:25px;">
			                            <label class="control-label">Chọn lĩnh vực:</label>
			                            <select class="form-control " id="formChonLinhVucChinhSua">
			                              <option value="10">English</option>
			                              <option value="20">Công nghệ thông tin</option>
			                              <option value="30">toán</option>
		                			  ...
		                			  <div class="form-group " style="padding-right:25px;">
			                            ...
			                            <select class="form-control " id="formChonBoMonChinhSua">
			                              ...
			                              <option value="40">Toán A1</option>
			                              <option value="40">Lý A1</option>
                        	     ...
                        	     <div  id="danhsachcauhoi" style="background: #E6E6FA; padding: 25px 25px; color:#0000CC">
                        	        <div>
											<div class="form-group" style="padding-bottom: 20px;">
					                            ...
					                            <select class="form-control" style="padding-right: 90px;"  id="selectChonChuDeChinhSua">
                                            ...
                                            <span class="label label-primary" style="font-size: 16px">Danh sách câu hỏi của chủ đề</span>
				                            <div class="form-group" >
													<table style="background: #FFCCCC;" class="table table-hover table-striped " >
														<thead>
															<tr>
																<th>Mã câu hỏi</th>
																<th>Nội dung</th>
									...
									<br>
									<div class="form-group">
										<span class="label label-primary" style="font-size: 16px">Danh sách câu hỏi được chọn</span>
				                            <div class="form-group" >
													<table style="background: #FFCCCC;" class="table table-hover table-striped " >
														<thead>
															<tr>
									...
									<div class="form-inline">
									    <label class="control-label">Số câu hỏi đã chọn/Tổng số:</label>
										<input type="text" class="form-control" name="" value="12/20" size="6px" >
									</div>
									<br>
									<div class="form-inline">
											...
											<div class="form-group">
												<label class="control-label " >Số lượng mã đề thi phát sinh:</label>
				                                  <input type="text" size="3px" class="form-control " id="ChonSoLuongDeThiChinhSua" name="Name_SoLuongMaDeThiChinhSua" ng-model="Model_SoLuongMaDeThiChinhSua" required>
	                	...
	                	<div class="tab-pane fade " id="taodethi">
							<form name="FormTaoDeThi_ALL">
                                 ...
                                 <div style="background: #E6E6FA; padding: 25px 25px 10px 25px; color:#0000CC">
                                 	 <div class="form-group">
			                              <label class="control-label" >Nhập tên đề thi chính:</label>
			                                ...
			                                <input type="text" class="form-control" name="Name_TenDeChinh" id="TenDeChinh" ng-model="Model_TenDeChinh"  required>
											<span class="ChuaNhapValue" ng-show="FormTaoDeThi_ALL.Name_TenDeChinh.$touched && FormTaoDeThi_ALL.Name_TenDeChinh.$invalid">Chưa nhập tên đề thi</span>
			                          </div>
                                 </div >
								 <div id="formNhapMaDeThi" class="form-inline"  style="background: #E6E6FA; padding: 10px 25px 25px 25px; color:#0000CC">
		                			   <div class="form-group " style="padding-right:25px;">
			                            <label class="control-label">Chọn lĩnh vực:</label>
		                        ...
		                        <div id="btnChoDanhSachCauHoi" class="form-group" style="background: #E6E6FA; padding: 25px 25px; color:#0000CC">
						    		<input type="button" id="huybo"  class="btn btn-primary" onclick="resetFunction()" value="Hủy bỏ">
